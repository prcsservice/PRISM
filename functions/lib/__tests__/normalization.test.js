...
describe("Individual normalization functions", () => {
    test("normSleep: 0 hours → max risk (1.0)", () => {
        expect((0, normalization_1.normSleep)(0)).toBe(1);
    });
    test("normSleep: 8 hours → no risk (0.0)", () => {
        expect((0, normalization_1.normSleep)(8)).toBe(0);
    });
    test("normSleep: 4 hours → 0.5 risk", () => {
        expect((0, normalization_1.normSleep)(4)).toBe(0.5);
    });
    test("normSleep: negative → clamped to 1.0", () => {
        expect((0, normalization_1.normSleep)(-2)).toBe(1);
    });
    test("normSleep: very high → clamped to 0.0", () => {
        expect((0, normalization_1.normSleep)(12)).toBe(0);
    });
    test("normScreenTime: 0 hrs → 0.0", () => {
        expect((0, normalization_1.normScreenTime)(0)).toBe(0);
    });
    test("normScreenTime: 10 hrs → 1.0", () => {
        expect((0, normalization_1.normScreenTime)(10)).toBe(1);
    });
    test("normScreenTime: 5 hrs → 0.5", () => {
        expect((0, normalization_1.normScreenTime)(5)).toBe(0.5);
    });
    test("normMood: 5 (Great) → 0.0 risk", () => {
        expect((0, normalization_1.normMood)(5)).toBe(0);
    });
    test("normMood: 1 (Very Bad) → 1.0 risk", () => {
        expect((0, normalization_1.normMood)(1)).toBe(1);
    });
    test("normMood: 3 (Neutral) → 0.5 risk", () => {
        expect((0, normalization_1.normMood)(3)).toBe(0.5);
    });
    test("normStudyHours: 6 hrs → 0.0", () => {
        expect((0, normalization_1.normStudyHours)(6)).toBe(0);
    });
    test("normStudyHours: 0 hrs → 1.0", () => {
        expect((0, normalization_1.normStudyHours)(0)).toBe(1);
    });
    test("normSocial: 5 (Very Active) → 0.0", () => {
        expect((0, normalization_1.normSocial)(5)).toBe(0);
    });
    test("normSocial: 1 (Isolated) → 1.0", () => {
        expect((0, normalization_1.normSocial)(1)).toBe(1);
    });
    test("normMarks: 100 → 0.0 risk", () => {
        expect((0, normalization_1.normMarks)(100)).toBe(0);
    });
    test("normMarks: 0 → 1.0 risk", () => {
        expect((0, normalization_1.normMarks)(0)).toBe(1);
    });
    test("normAttendance: 100% → 0.0", () => {
        expect((0, normalization_1.normAttendance)(100)).toBe(0);
    });
    test("normAttendance: 0% → 1.0", () => {
        expect((0, normalization_1.normAttendance)(0)).toBe(1);
    });
    test("normFeedback: 5 → 0.0", () => {
        expect((0, normalization_1.normFeedback)(5)).toBe(0);
    });
    test("normFeedback: 1 → 1.0", () => {
        expect((0, normalization_1.normFeedback)(1)).toBe(1);
    });
});
describe("normalizeAll", () => {
    test("returns all 8 normalized features", () => {
        const result = (0, normalization_1.normalizeAll)({
            sleepHours: 8,
            screenTimeHours: 0,
            mood: 5,
            studyHours: 6,
...
describe("computeScores", () => {
    test("all-zero features → Low risk", () => {
        ...
        const result = (0, normalization_1.computeScores)(features);
...
describe("Alert threshold behavior", () => {
    test("Low risk → no alert should be created", () => {
        const result = (0, normalization_1.computeScores)({
            sleepNorm: 0, screenTimeNorm: 0, moodNorm: 0, studyNorm: 0,
            socialNorm: 0, marksNorm: 0, attendanceNorm: 0, feedbackNorm: 0,
        });
        expect(result.riskLevel).toBe("Low");
